...
if ( ! class_exists( 'awsmug\APIAPI\Hooks' ) ) {
	...
	class Hooks {
		 ...
		 *
		 * The returned hook object can be passed to `awsmug\APIAPI\Hooks::off()` to
		 * remove it again.
		 *
		 * @since 1.0.0
		 * @access public
		 ...
		 * @return awsmug\APIAPI\Hook Hook object.
		 */
		 ...
		 *
		 * The object to pass to this method must have been returned by `awsmug\APIAPI\Hooks::on()`.
		 *
		 * @since 1.0.0
		 * @access public
		 *
		 ...
		 * @access protected
		 *
		 * @param awsmug\APIAPI\Hook $hook1 First hook object.
		 * @param awsmug\APIAPI\Hook $hook2 Second hook object.
